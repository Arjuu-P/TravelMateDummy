...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder> {
    ...
    public HotelAdapter(Context context, JSONArray data) {
        ...
        try {
            ...
            holder.link.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String url = null;
                    try {
                        url = currentObject.getString("map_link");
    ...
    private void BookNow(String date, String peoples, JSONObject currentObject, ViewHolder holder) {
        Call<String> call =  messageInterface.sendMessage(
                ...
                "Thankyou for Booking Hotel with Travel Mate, Your booking is confirmed.",
                "TESTKK",
                "3",
                "1507161717524942102"
        );
